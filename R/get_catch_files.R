...
usethis::use_data(catch_files_CT, overwrite = T)
...
usethis::use_data(catch_files_DE, overwrite = T)
...
usethis::use_data(catch_files_MA, overwrite = T)
...
usethis::use_data(catch_files_MD, overwrite = T)
...
usethis::use_data(catch_files_NJ, overwrite = T)
...
usethis::use_data(catch_files_NY, overwrite = T)
...
usethis::use_data(catch_files_RI, overwrite = T)
...
usethis::use_data(catch_files_VA, overwrite = T)
