...
sf_size_dat <- readr::read_csv(file.path(here::here("data-raw/size_data/fluke_prob_star_2024_CT.csv")),  show_col_types = FALSE) 

bsb_size_dat <- readr::read_csv(file.path(here::here("data-raw/size_data/bsb_prob_star_2022_CT.csv")),  show_col_types = FALSE)

scup_size_dat <- readr::read_csv(file.path(here::here("data-raw/size_data/scup_prob_star_2024_CT.csv")),  show_col_types = FALSE)
...
get_predictions_out<- function(x){
  ...
  catch_files_CT<- readr::read_csv(file.path(here::here(paste0("data-raw/catch2024/", state1, " catch draws 2024 draw4 ",x ,".csv")))) %>% 
