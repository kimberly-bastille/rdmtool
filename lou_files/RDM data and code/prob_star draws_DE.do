...
u `base', clear 	
preserve 
import delimited using "pstar_DE_test1.csv", clear 
...
save "fluke_prob_star_2022_DE.dta", replace
...
save "bsb_prob_star_2022_DE.dta", replace
...
save "scup_prob_star_2022_DE.dta", replace
