...
u `base', clear 	
preserve 
import delimited using "pstar_CT_test1.csv", clear 
...
gen p_star=`p_star_pr' if length== 18 & mode=="pr"
replace p_star=`p_star_fh' if  length== 18 & mode=="fh"
replace p_star= `p_star_sh' if  length== 18 & mode=="sh"
...
save "fluke_prob_star_2022_CT.dta", replace
...
save "bsb_prob_star_2022_CT.dta", replace
...
save "scup_prob_star_2022_CT.dta", replace
