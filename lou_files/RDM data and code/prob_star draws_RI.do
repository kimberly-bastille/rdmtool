...
u `base', clear 	
preserve 
import delimited using "pstar_RI_test1.csv", clear 
...
gen p_star=`p_star_pr' if length== 17.5 & mode=="pr"
replace p_star=`p_star_fh' if  length== 17.5 & mode=="fh"
replace p_star= `p_star_sh' if  length== 17.5 & mode=="sh"
...
save "fluke_prob_star_2022_RI.dta", replace
...
save "bsb_prob_star_2022_RI.dta", replace
...
save "scup_prob_star_2022_RI.dta", replace
