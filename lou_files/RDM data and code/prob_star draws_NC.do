...
u `base', clear 	
preserve 
import delimited using "pstar_NC_test1.csv", clear 
replace p_star=1 if p_star>1 | p_star==.
replace p_star=0 if p_star<0
...
gen p_star=`p_star_pr' if length== 14.5 & mode=="pr"
replace p_star=`p_star_fh' if  length== 14.5 & mode=="fh"
replace p_star= `p_star_sh' if  length== 14.5 & mode=="sh"
...
save "fluke_prob_star_2022_NC.dta", replace
...
save "bsb_prob_star_2022_NC.dta", replace
...
save "scup_prob_star_2022_NC.dta", replace
