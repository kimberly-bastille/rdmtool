...
u `base', clear 	
preserve 
import delimited using "pstar_MA_test1.csv", clear 
...
gen p_star=`p_star_pr' if length== 16 & mode=="pr"
replace p_star=`p_star_fh' if  length== 16 & mode=="fh"
replace p_star= `p_star_sh' if  length== 16 & mode=="sh"
...
save "fluke_prob_star_2022_MA.dta", replace
...
save "bsb_prob_star_2022_MA.dta", replace
...
save "scup_prob_star_2022_MA.dta", replace
